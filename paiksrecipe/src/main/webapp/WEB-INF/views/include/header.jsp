...
<html>
			...
			<div class="header_wrap">
				<div class="header_content">
					<div class="header_content_logo">
						<a href="#"> <img class="header_content_logo_img" src="${path}/resources/img/logo.png"> <span></span>
						</a>
					</div>
	...
	$(document).ready(function(){ 
		...
		// 회원, 비회원 클릭시 태두리색 변경 
		$(document).on('focus', '.tab_cliker_wrap', function() {
			$(this).css('border-bottom', '1px solid #B22230');
		});
		$(document).on('blur', '.tab_cliker_wrap', function() {
			$(this).css('border-bottom', '1px solid #e9e9e9');
		});
		...
		$(document).on('click', '.login_close', function() {
					...
					$('.pw_eye').html('<i class="fas fa-eye-slash"></i>').css('color', '#666');
				});
		...
		$(document).on(
				...
				function() {
					...
					if (code == 'password') {
						...
						$(this).html('<i class="fas fa-eye"></i>').css('color', '#666');
					} else {
						$(this).prev().attr('type', 'password');
						$(this).html('<i class="fas fa-eye-slash"></i>').css('color', '#666');
					}
				});
