					...
					<div class="join_content">
						<div class="row_group">
							<div class="join_row">
								...
								<div class="ps_box int_id">
									<input type="email" id="uid" name="id" class="int"
								...
								<div class="pw_wrap">
									<div class="ps_box int_pass">
										<input type="text" id="upw" name="pw" class="int"
											placeholder="비밀번호 입력"> <span class="step_url">
											<span class="pw_lock"></span>
										</span> <span class="step_url"> <span class="repw_lock1"></span>
										</span>
									</div>
									<div class="ps_box int_pass">
										<input type="text" id="urpw" name="urpw" class="int"
											placeholder="비밀번호 재입력"> <span class="step_url">
						...
						<div class="row_group">
							...
							<div class="join_row">
								...
								<div class="ps_box">
									<input type="text" id="uemail" class="int" name="email"
							...
							<div class="join_row">
								...
								<div class="ps_box">
									<input type="tel" id="phone" class="int" name="phone"
			...
			<div id="footer">
				...
				<div id="address">
					<span> <a href="#"> <img id="addr_logo"
							...
							href="#">PAIK'S RECIPE Corp.</a></strong></span> <span>All Rights
						Reserved.</span>
				</div>
			</div>
		</footer>
