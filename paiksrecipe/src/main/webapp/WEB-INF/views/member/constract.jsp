						...
						<div class="terms">
							<p class="terms_p">
								<span class="terms_span"> <input type="checkbox" id="cbox">
									<label for=cbox> 이용약관, 개인정보 수집 및 이용, 위치정보 이용약 <br>관(선택), 프로모션 안내 메인 수신(선택)에 모두 동<br>의합니다.
								</label>
							...
							<ul class="terms_ul">
								...
								<li class="terms_ul_li3">
									...
									<div class="terms_box">
										<div class="article">
											<p>
												위치정보 이용약관에 동의하시면, <b>위치를 활용한 광고 정보 수신</b> 등을 포함하는 PAIK'S RECIPE 위치기반 서비스를 이용할 수 있습니다.
											</p>
											<h3 class="article_title">제 1 조 (목적)</h3>
											<p>이 약관은 PAIK'S RECIPE 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
										</div>
									</div></li>
			...
			<footer>
				<div id="footer">
					...
					<div id="address">
						...
						<span>Copyright</span> 
						<span>ⓒ</span> 
						<span><strong><a href="#">PAIK'S RECIPE Corp.</a></strong></span> 
