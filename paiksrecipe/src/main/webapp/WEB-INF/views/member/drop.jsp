		...
		<div class="wrap">
				...
				<form name="" method="" action="">
					<div class="info_id_wrap">
						<div class="info_id_content">
							<div class="info_id_reuse info_id">
								<div class="id_content">
									...
									<p>
										회원탈퇴 진행 시 본인을 포함한 타인 모두 <span style="color: red">아이디 재사용이나 복구가 불가능합니다.</span>
									</p>
									<p>신중히 선택하신 후 결정해주세요.</p>
								</div>
								<span class="agree_box"> 
									<input type="checkbox" class="cbox" id="cbox1"> 
									<label for="cbox1">동의</label>
								</span>
							</div>
							<div class="info_id_delete info_id">
								...
								<span class="agree_box"> 
									<input type="checkbox" class="cbox" id="cbox2"> 
									<label for="cbox2">동의</label>
								</span>
							</div>
							<div class="info_id_delete info_id">
								<div class="id_content">
									...
									<p>
										탈퇴 후에는 회원정보가 삭제되어 본인 여부를 확인할 수 있는 방법이 없어, <span style="color: red">게시글을 임의로 삭제해드릴 수 없습니다.</span>
									</p>
								</div>
								<span class="agree_box"> 
									<input type="checkbox" class="cbox" id="cbox3"> 
									<label for="cbox3">동의</label>
								</span>
							</div>
						...
						<div class="info_id_button">
							<a href="#" class="button1"><strong>탈퇴 취소</strong></a> 
							<a href="#" class="button2"><strong>탈퇴 확인</strong></a>
						</div>
					</div>
				</form>
			</section>
			<footer>
				<div id="footer">
					...
					<div id="address">
						<span> 
							<a href="#"><img id="addr_logo" src="${path}/resources/img/logo.png"></a>
						</span> 
						<span>Copyright</span> 
						<span>ⓒ</span> 
						<span>
							<strong><a href="#">PAIK'S RECIPE Corp.</a></strong>
						</span> 
