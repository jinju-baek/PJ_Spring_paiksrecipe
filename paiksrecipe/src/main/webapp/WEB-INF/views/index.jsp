									...
									<div class="subclass">
										<ul>
											<li>
												...
												<label for="1-1">1목록-1</label>
											</li>
											<li>
												<input type="checkbox" name="" id="1-2">
												<label for="1-2">1목록-2</label>
											</li>
											<li>
												<input type="checkbox" name="" id="1-3">
												<label for="1-3">1목록-3</label>
											</li>
											<li>
												<input type="checkbox" name="" id="1-4">
												<label for="1-4">1목록-4</label>
											</li>
											<li>
												<input type="checkbox" name="" id="1-5">
												<label for="1-5">1목록-5</label>
											</li>
										</ul>
									</div>
									<div class="subclass">
										<ul>
											<li>
												...
												<label for="2-1">2목록-1</label>
											</li>
											<li>
												<input type="checkbox" name="" id="2-2">
												<label for="2-2">2목록-2</label>
											</li>
											<li>
												<input type="checkbox" name="" id="2-3">
												<label for="2-3">2목록-3</label>
											</li>
											<li>
												<input type="checkbox" name="" id="2-4">
												<label for="2-4">2목록-4</label>
											</li>
											<li>
												<input type="checkbox" name="" id="2-5">
												<label for="2-5">2목록-5</label>
											</li>
										</ul>
									</div>
									<div class="subclass">
										<ul>
											<li>
												...
												<label for="3-1">3목록-1</label>
											</li>
											<li>
												<input type="checkbox" name="" id="3-2">
												<label for="3-2">3목록-2</label>
											</li>
											<li>
												<input type="checkbox" name="" id="3-3">
												<label for="3-3">3목록-3</label>
											</li>
											<li>
												<input type="checkbox" name="" id="3-4">
												<label for="3-4">3목록-4</label>
											</li>
											<li>
												<input type="checkbox" name="" id="3-5">
												<label for="3-5">3목록-5</label>
											</li>
										</ul>
									</div>
									<div class="subclass">
										<ul>
											<li>
												...
												<label for="4-1">4목록-1</label>
											</li>
											<li>
												<input type="checkbox" name="" id="4-2">
												<label for="4-2">4목록-2</label>
											</li>
											<li>
												<input type="checkbox" name="" id="4-3">
												<label for="4-3">4목록-3</label>
											</li>
											<li>
												<input type="checkbox" name="" id="4-4">
												<label for="4-4">4목록-4</label>
											</li>
											<li>
												<input type="checkbox" name="" id="4-5">
												<label for="4-5">4목록-5</label>
											</li>
										</ul>
									</div>
									<div class="subclass">
										<ul>
											<li>
												<input type="checkbox" name="" id="5-1">
												<label for="5-1">5목록-1</label>
											</li>
											<li>
												<input type="checkbox" name="" id="5-2">
												<label for="5-2">5목록-2</label>
											</li>
											<li>
												<input type="checkbox" name="" id="5-3">
												<label for="5-3">5목록-3</label>
											</li>
											<li>
												<input type="checkbox" name="" id="5-4">
												<label for="5-4">5목록-4</label>
											</li>
											<li>
												<input type="checkbox" name="" id="5-5">
												<label for="5-5">5목록-5</label>
											</li>
										</ul>
									</div>
									<div class="subclass">
										<ul>
											<li>
												<input type="checkbox" name="" id="6-1">
												<label for="6-1">6목록-1</label>
											</li>
											<li>
												<input type="checkbox" name="" id="6-2">
												<label for="6-2">6목록-2</label>
											</li>
											<li>
												<input type="checkbox" name="" id="6-3">
												<label for="6-3">6목록-3</label>
											</li>
											<li>
												<input type="checkbox" name="" id="6-4">
												<label for="6-4">6목록-4</label>
											</li>
											<li>
												<input type="checkbox" name="" id="6-5">
												<label for="6-5">6목록-5</label>
											</li>
										</ul>
									</div>
								</div>
